...
class Gateway extends AbstractGateway
{
     ...
     *
     * @return \Omnipay\MOLPayMY\Message\PurchaseRequest
     */
    public function purchase(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\MOLPayMY\Message\PurchaseRequest', $parameters);
    }
     ...
     * @param array $parameters
     *
     * @return \Omnipay\MOLPayMY\Message\CompletePurchaseRequest
     */
    public function completePurchase(array $parameters = array())
    {
        return $this->createRequest(
            '\Omnipay\MOLPayMY\Message\CompletePurchaseRequest',
            array_merge(
                $parameters,
                array(
