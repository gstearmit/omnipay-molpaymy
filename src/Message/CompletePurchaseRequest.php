...
class CompletePurchaseRequest extends AbstractRequest
{
    ...
    /**
     * Convert currency to 'MOLPayMY''s style currency.
     * @NOTE Funny enough, MOLPayMY returns currency as 'RM' not 'MYR'. And I am not sure about other currencies though.
     *
     * @return string
     */
